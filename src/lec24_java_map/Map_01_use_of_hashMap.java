...
public class Map_01_use_of_hashMap {	
	public static void main(String[] args) {
		...
		// So, how can we get the value one by one based on key
		
		// Here, k is the name of the loop which sorted the key value from allKeys
		
		for(String k: allKeys) {
			System.out.println(k + " = " + nameAndAge.get(k) );
		}
